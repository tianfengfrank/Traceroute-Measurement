...
def hosttogeo_online_ipip(dst):
	...
	req.add_header("Token","803a1a0ccfe9c4090e0ac733953633ad0cb443f2")
	#qq：9a8bc1a059db4a14b4feb0f38db38bbf4d5353ab   #163：f4f24f5817d67448fd6c7137fdf5bbc0cec7b4ec
	 #sina：826d2ebfc79dc1ccfac3a6f2c1ea6a6b7bafd423 #gmail：803a1a0ccfe9c4090e0ac733953633ad0cb443f2
	while attempts < 3 and not success:
			try:
...
def traceall_db(filename,dirname,ISP):
	...
	db_handle = db.cursor()
	db.text_factory = str
	query="select Url,CityId from beacon where ISP like '%"+ISP+"%'"
